    ...
    featureIcons.premium
          ...
          >
            ...
            <div className="mt-6 flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-gray-400">+91 9818223111</p>
              </div>
            </div>
      ...
      <div className="w-full bg-black py-20">
        <section ref={sectionRef} className="comparisonSection">
          ...
          <div ref={afterRef} className="comparisonImage afterImage">
            <img ref={afterImgRef} src={property.images[1]} />
          </div>
        </section>
      </div>
      {showGallery && (
        ...
        >
          ...
          <img
            src={property.images[index]}
            className="max-h-[90%] rounded-xl transition-all duration-300"
          />
          <div className="absolute bottom-6 flex gap-2">
            {property.images.map((_: any, i: number) => (
              <div
                key={i}
                className={`w-2 h-2 rounded-full ${index === i ? "bg-[#D4AF37]" : "bg-gray-500"
                  }`}
              />
            ))}
          </div>
        ...
        <div className="relative max-w-7xl mx-auto px-6">
          ...
          <div className="max-w-3xl mb-20">
            ...
            <h2 className="text-5xl md:text-7xl font-bold leading-tight mb-8">
              Why This <br /> Property Stands Out
            </h2>

            <p className="text-gray-400 text-lg leading-relaxed">
              Designed for modern luxury living with elegant architecture,
              premium amenities, smart infrastructure, and unmatched connectivity.
            </p>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            >
              ...
              <div className="absolute inset-0 bg-gradient-to-b from-[#D4AF37]/10 to-transparent opacity-0 group-hover:opacity-100 transition duration-500" />
              ...
              <div className="relative">
                ...
                <p className="text-gray-400 leading-relaxed">
                  Experience world-class luxury amenities, elegant interiors,
                  landscaped greens, and resort-inspired living spaces.
                </p>
            ...
            >
              ...
              <div className="relative">
                ...
                <p className="text-gray-400 leading-relaxed">
                  Strategically located near expressways, metro stations,
                  business hubs, schools, and upcoming infrastructure.
                </p>
            ...
            >
              ...
              <div className="relative">
                ...
                <p className="text-gray-400 leading-relaxed">
                  Located in one of the fastest-growing luxury corridors
                  with strong appreciation and future investment potential.
                </p>
        ...
        <div className="relative max-w-7xl mx-auto px-6">
          ...
          <div className="text-center mb-20">
            ...
            <p className="text-gray-400 max-w-2xl mx-auto text-lg">
              Every detail is carefully crafted to deliver elegance,
              comfort, and a premium lifestyle experience.
            </p>
          ...
          <div className="grid md:grid-cols-4 gap-8">
            ...
            {property.stats?.map((item: any, i: number) => (
              ...
              >
                ...
                {/* HOVER GLOW */}
                <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition duration-500 bg-gradient-to-b from-[#D4AF37]/20 to-transparent" />

                <div className="relative">

                  <h2 className="text-5xl md:text-6xl font-bold text-[#D4AF37] mb-5 leading-tight">
                    {item.number}
                  </h2>
      ...
      <section className="relative py-32 bg-[#0B0B0B] overflow-hidden">
        ...
        {/* GOLD GLOW */}
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[700px] h-[400px] bg-[#D4AF37]/10 blur-[150px]" />
        ...
        <div className="relative max-w-7xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <motion.div
              whileHover={{ y: -8 }}
              className="bg-[#111]/90 border border-white/10 rounded-[28px] p-10 backdrop-blur-xl hover:border-[#D4AF37]/40 transition-all duration-500"
            >

              <div className="w-16 h-16 rounded-2xl bg-[#D4AF37]/10 flex items-center justify-center text-3xl mb-8">
                🏙️
              </div>
              ...
              <p className="text-gray-400 leading-relaxed">
                Premium elevation design with expansive balconies,
                modern glass façade, and luxury skyline aesthetics.
              </p>
            ...
            >
              ...
              <p className="text-gray-400 leading-relaxed">
                Landscaped gardens, wellness zones, peaceful walkways,
                and nature-inspired open spaces for premium living.
              </p>
            ...
            >
              ...
              <p className="text-gray-400 leading-relaxed">
                Elegant textures, spacious layouts, imported finishes,
                and modern smart-home experiences throughout.
              </p>
